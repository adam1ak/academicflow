...
function DeadlineCard({ type, title, date, classroom }: DeadlineCardProps) {
    ...
    return (
        <div className="flex items-center gap-2.5">
            <div className={`flex shrink-0 flex-col justify-center items-center rounded-lg ${styles.bgColor} w-10 h-10 border ${styles.bgBorder}`}>
                <span className={`font-mono uppercase trackingwidest text-[8px] ${styles.text}`}>{date}</span>
            ...
            <div className="flex flex-col">
                ...
                <div className="flex gap-2 items-center">
                    ...
                    <span className={`font-mono rounded text-[8px] text ${styles.typeBg} ${styles.text} px-1.5 py-0.5`}>{type}</span>
                </div>
